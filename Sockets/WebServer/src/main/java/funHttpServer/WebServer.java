        ...
        try {
            ...
            if (request == null) {
                ...
                if (request.length() == 0) {
                    ...
                    // Set default values
                    Integer num1 = 1; // Default value for num1
                    Integer num2 = 2; // Default value for num2
                    boolean validInput = true; // Flag to check if inputs are valid

                    // Check if num1 is provided and valid
                    if (num1Str != null) {
                        try {
                    ...
                    // Generate response based on the validity of the inputs
                    if (!validInput) {
                    ...
                    try {
                        ...
                        JSONArray repos = new JSONArray(jsonResponse); // Parse JSON array

                        StringBuilder responseBuilder = new StringBuilder();
                        responseBuilder.append("<html><body>");
                        responseBuilder.append("<h1>Public Repositories:</h1>");
                    ...
                    // Check if start is provided and valid
                    if (startStr != null) {
                        try {
                    ...
                    if (nStr != null) {
                        try {
                            ...
                            if (n < 1) {
                                validInput = false; // n must be a positive integer
                            }
                        } catch (NumberFormatException e) {
                            validInput = false;
                        }
                    ...
                    if (!validInput) {
                        ...
                        builder.append("Content-Type: text/html; charset=utf-8\n");
                        builder.append("\n");
                        builder.append("Error: start must be an integer, and n must be a positive integer.");
                    } else {
                        // Calculate Fibonacci sequence starting from the given number
                        StringBuilder fibSequence = new StringBuilder();
                        int a = start, b = start + 1; // Initialize first two terms

                        for (int i = 0; i < n; i++) {
                            fibSequence.append(a).append(i < n - 1 ? ", " : "");
                            int next = a + b;
                            a = b;
                            b = next;
                        }
                        ...
                        builder.append("Content-Type: text/html; charset=utf-8\n");
                        builder.append("\n");
                        builder.append("Fibonacci sequence starting from " + start
                                + " for " + n + " terms: " + fibSequence.toString());
                    }
                    ...
                    if (str1 == null || str2 == null) {
                        ...
                        builder.append("Content-Type: text/html; charset=utf-8\n");
                        builder.append("\n");
                        builder.append("Error: Both str1 and str2 must be provided.");
                    } else {
                        // Concatenate strings
